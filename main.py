...
def create_args_config():
    ...
    parser.add_argument("--ab_original_dir", type=str,  default='./output1/phase1_ab_original')
    parser.add_argument("--ab_scheduled_dir", type=str, default='./output1/phase2_ab_scheduled')
    parser.add_argument("--ab_summary_dir", type=str,   default='./output1/phase3_ab_summary')
    parser.add_argument("--ss_plan_file", type=str,     default="./output1/vubo_ss_plan.txt")
    ...
    parser.add_argument("--method_arr", nargs='+', type=str, default=['ddim'])
    ...
    parser.add_argument("--sample_output_dir", type=str, default='output1/generated/')
    ...
    parser.add_argument("--weight_file", type=str, default='./output1/res_mse_avg_list.txt')
